...
- Trains XGBoost model on UCI Student Performance dataset
- Uses scikit-learn for preprocessing and evaluation
...
def load_and_prepare(csv_path: str) -> tuple:
    """Load UCI student data and prepare features/labels."""
    ...
    # Target: fail if G3 < 10
    # Handle both 'g3' and 'G3'
    g3_col = None
    for c in df.columns:
        if c.lower() == "g3":
            g3_col = c
...
if __name__ == "__main__":
    import sys
    csv_path = sys.argv[1] if len(sys.argv) > 1 else "student-mat.csv"
